...
insert into classes values  ('c0004', 'CS', 432, 1, 2019, 'Spring', 30, 30);
insert into classes values  ('c0005', 'CS', 240, 1, 2019, 'Fall', 40, 39);
insert into classes values  ('c0006', 'CS', 532, 1, 2019, 'Spring', 29, 28);
insert into classes values  ('c0007', 'Math', 221, 1, 2020, 'Spring', 30, 30);
